...
#
export PUB_INC_PATHS += -I${PROJECT_BASE}/include \
    ...
    -I${PROJECT_ROOT}/arduino-lite/libraries/MqttClient/paho/rocket \
    -I${PROJECT_ROOT}/arduino-lite 



export LIB_SOURCE += $(PROJECT_ROOT)/arduino-lite/libraries/MqttClient/rocket/